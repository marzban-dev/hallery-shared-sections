...
const NavbarContainer: React.FC<INavbarContainerProps> = ({ children }) => {
    return (
        <nav className="bottom-0 z-50 flex w-full items-start justify-center max-[800px]:fixed min-[430px]:bottom-[20px] min-[800px]:h-screen min-[800px]:w-[100px] min-[1000px]:w-[250px]">
            <ul className="flex gap-2 max-[800px]:bg-[rgba(20,20,20,0.8)] max-[800px]:px-4 max-[800px]:backdrop-blur-xl max-[430px]:w-full max-[430px]:justify-center max-[430px]:border-t max-[430px]:border-[rgb(50,50,50)] min-[420px]:gap-5 min-[430px]:rounded-full min-[800px]:flex-col min-[800px]:pt-[40px]">
